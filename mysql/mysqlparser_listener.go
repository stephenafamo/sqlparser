...
type MySqlParserListener interface {
	...
	// EnterBindExpressionAtom is called when entering the bindExpressionAtom production.
	EnterBindExpressionAtom(c *BindExpressionAtomContext)
	...
	// ExitBindExpressionAtom is called when exiting the bindExpressionAtom production.
	ExitBindExpressionAtom(c *BindExpressionAtomContext)
